    ...
    public partial class frmUpdatePassword : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Password mismatch", "Error Data - HMS", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        void selectUsers()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Invalid Username or Password or ID", "Error - HMS", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        void updateUser()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    MessageBox.Show("Updated successfully", "Save Data - HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
