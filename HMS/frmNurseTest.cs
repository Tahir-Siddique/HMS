...
namespace Onana_Hospital_Management_System
{
    public partial class frmNurseTest : Form
    {
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (checkBox1.Checked)
            {
                ...
                else
                {
                    ...
                    MessageBox.Show("Either Height or Weight value is not numeric" + Environment.NewLine + "Please check the values", "Error - HMS", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please fill all fields and make sure Compute BMI is checked", "Error - HMS", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
                 }
