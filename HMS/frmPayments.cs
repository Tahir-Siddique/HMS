    ...
    public partial class frmPayments : Form
    {
     ...
     // string dbPath = @"Data Source=SONY\MSSQLSERVER00V1;Initial Catalog=dbOHMS;Integrated Security=True";
            ...
            try
            {
                if (txtPatID.Text.Trim() != "")
                {
                    if (txtAmt.Text == "0")
                    {
                        ...
                        MessageBox.Show("Patient owes nothing", "Save Data - HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        return;
                    }
                    else
                    {
       ...
       int  StartYpos= 0;
        ...
        e.Graphics.DrawString("HOSPITAL MANAGEMENT SYSTEM" + Environment.NewLine, pfont, Brushes.Black, StartXpos, StartYpos);
