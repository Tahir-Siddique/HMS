      ...
      void validateConfirmPass(Control ctrl)
      {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    MessageBox.Show("Password mismatch !", "Error - HMS", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
        ...
        public void Valinput(ComboBox cobUser)
        {
            try
            {
                ...
                if (count == 1)
                {
                    MessageBox.Show("User Already Exist", "Save Data - HMS", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return;
                }
                else
                {
