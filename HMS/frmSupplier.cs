        ...
        private void button3_Click(object sender, EventArgs e)
        {
          ...
          SqlConnection  con = new SqlConnection(varinsert.dbPath);
            ...
            SqlCommand cmd = new SqlCommand(sql, con);
               ...
               MessageBox.Show(dataGridView1.RowCount.ToString() + " Record(s) found", "Search Result - HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);

            }

            else
            {
                MessageBox.Show(" Record(s) not found", "Search Result - HMS", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
