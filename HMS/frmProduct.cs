    ...
    public partial class frmProduct : Form
    {
       ...
       clsUpdate theUpdates = new clsUpdate();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            validateItemLoc(txtItemLocation);
               ...
               else
               {
                   ...
                   {
                       MessageBox.Show("Item is Expire", "Expire Product - HMS", MessageBoxButtons.OK, MessageBoxIcon.Error);
                       return;
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Item Number", "Error - HMS", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        private void btnSell_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageBox.Show("Invalid Patient ID", "Error - HMS", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        void UpdateBalance()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    MessageBox.Show("Payment updated successfully", "Save Data - HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch (Exception ex)
                {
                    MessageBox.Show(ex.Message);
        ...
        void ProcessInput()
        {
            ...
            if (proQty < 0)
            { 
                 MessageBox.Show("Qty instock is less qty requested", "Save Data - HMS", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                 return;
            }
        ...
        void updateProduct()
        {
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("Product updated successfully ", "Save Data - HMS", MessageBoxButtons.OK, MessageBoxIcon.Information);
                con.Close();
            }
            catch (Exception ex)
            {
